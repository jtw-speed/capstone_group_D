...
{
  int b_size_original = position2 -> b_size;
  int r_size_original = position2 -> r_size;
  int g_size_original = position2 -> g_size;
  ...
  int b_array = position2 -> b_img_x.size();
  int r_array = position2 -> r_img_x.size();
  int g_array = position2 -> g_img_x.size();
